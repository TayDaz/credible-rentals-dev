      ...
      {showProductModal && (
        <div className='product-modal__container'>
          ...
          <div className='p-d-flex p-flex-nowrap p-jc-center content__container'>
            <div
              className='p-d-flex p-jc-end p-mr-4 p-ai-center navigation-buttons previous-button__container'
            ...
            <div
              className='p-d-flex p-ai-center  p-ml-4  navigation-buttons next-button__container'
